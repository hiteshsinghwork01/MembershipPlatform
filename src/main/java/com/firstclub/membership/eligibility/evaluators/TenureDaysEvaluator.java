...
@Component
public class TenureDaysEvaluator implements CriteriaEvaluator {

    @Override
    public String getSupportedType() {
        return CriteriaType.TENURE_DAYS.name();
    }
    ...
    public boolean evaluate(TierEligibilityCriteria criteria, EligibilityContext context) {
        ...
        BigDecimal actual = BigDecimal.valueOf(context.getAccountAgeDays());
